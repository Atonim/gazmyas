class PositionCalculator {
  ...
  static calculateObjectPosition(flags, playerCoords, objectInfo) {
    ...
    console.log("checking", x2, y2, d2, a2);
    let i = 0,
      j = 1;
    ...
    console.log("yo", x1, y1, da1, x2, y2, d2, x3, y3, da3);
